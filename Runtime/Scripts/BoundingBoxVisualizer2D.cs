...
{
    /// <summary>
    /// BoundingBoxVisualizer2D is a MonoBehaviour class responsible for displaying 2D bounding boxes, labels, and label backgrounds
    ...
    /// </summary>
    public class BoundingBoxVisualizer2D : MonoBehaviour
    {
        // UI components
        [Header("Components")]
